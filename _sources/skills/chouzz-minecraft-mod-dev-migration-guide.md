# Minecraft Mod Migration and Code Refactoring Protocol (1.21+)

> 来源：https://github.com/chouzz/minecraft-mod-dev → references/migration-guide.md（原版全文）
...
5. **Compatibility Check:** Verify correct **Convenience Tags** are used (e.g., `#c:ores/iron`).
